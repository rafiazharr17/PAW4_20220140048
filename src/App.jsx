...
export default function App() {
  ...
  return (
    ...
    >
      <div
        className="bg-gray-500 p-10 rounded-lg shadow md max-w-md w-full bg-clip-padding backdrop-filter 
...
border-gray-100 text-white py-2 px-4 rounded hover:bg gray-500 hover:bg-opacity-10 hover:border-black 
